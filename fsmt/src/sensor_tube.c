...
fsmt_sensor_tube_t* fsmt_sensor_tube_create(size_t max_size)
{
    ...
    tube->samples.whiskers.outer = fsmt_sensor_point_array_create(10);
    tube->samples.whiskers.inner = fsmt_sensor_point_array_create(10);
